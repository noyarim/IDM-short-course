...
## Adds vaccination to the basic SIR model (closed population)
This code is to illustrate how to model vaccination in an SIR model without demography (no births or deaths).
...
In the next set of codes, we are going to perform sensitivity analysis on (1) vaccination rate, (2) vaccine effectiveness, and (3) the ratio in effective contact rate between vaccinated and non-vaccinated individuals to see how varying those parameter values changes projected epidemics. (1) and (2) will be done in SIR_Vax_ip1 and (3) will be done in SIR_Vax_ip2.
