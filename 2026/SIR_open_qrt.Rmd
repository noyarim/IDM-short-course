...
## Adds quarantine to the basic SIR model with demography
This code is to illustrate how to model quarantine in an SIR model with demography. In the differential equation, we have Q compartment that indicates individuals who are infected and isolated under quarantine.
