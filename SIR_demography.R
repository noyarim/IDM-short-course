...
#4. We didn't go over this in the slides, but in this model there are equations for the study state distribution
...
#see how this matches the proportions in the graph
